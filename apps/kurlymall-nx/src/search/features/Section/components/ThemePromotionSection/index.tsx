...
import { ThemePromotionSectionViewModel, ThemePromotionSectionItemViewModel } from '../../factory';
...
type OnClickProductCardFn = (product: ThemePromotionSectionItemViewModel) => void;
type OnClickProductCardShortCutFn = (product: ThemePromotionSectionItemViewModel, meta: ProductShortCutMeta) => void;

type SectionItemProps = {
  data: ThemePromotionSectionItemViewModel;
...
type Props = {
  section: ThemePromotionSectionViewModel;
};

const ThemePromotionSection = ({ section }: Props) => {
