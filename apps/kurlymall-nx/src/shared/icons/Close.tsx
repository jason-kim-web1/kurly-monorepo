...
export default function Close({
  ...
  return (
    <svg width={width} height={height} viewBox={'0 0 32 32'} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g clipPath="url(#clip0_2073_60924)">
        <path d="M26 26L6 6" stroke={stroke} strokeLinecap={strokeLinecap} strokeWidth={strokeWidth} />
        <path d="M6 26L26 6" stroke={stroke} strokeLinecap={strokeLinecap} strokeWidth={strokeWidth} />
      </g>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
