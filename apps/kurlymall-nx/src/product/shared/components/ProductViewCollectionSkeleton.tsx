...
const ProductItem = () => {
  return (
    <ProductItemWrap>
      <SkeletonBox borderRadius={vars.radius.$10} height={120} />
      <SkeletonBox borderRadius={vars.radius.$8} height={40} margin={`${vars.spacing.$8} 0 0 0`} />
      <SkeletonBox borderRadius={vars.radius.$8} height={20} margin={`${vars.spacing.$4} 0 0 0`} />
    </ProductItemWrap>
  );
};

const ProductViewCollectionSkeleton = () => {
...
export { ProductViewCollectionSkeleton };
