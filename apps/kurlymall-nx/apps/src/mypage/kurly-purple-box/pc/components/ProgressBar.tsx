...
export default function ProgressBar() {
  ...
  return (
    <Wrapper>
      <BarWrapper>
        <StateBar progressBarWidth={progressBarWidth} data-testid="state-bar">
          <StateDot />
        </StateBar>
      </BarWrapper>
      <StatusWrapper>
        <Requested>신청접수</Requested>
        <Progressed requestState={personalBox?.requestState} data-testid="progressed">
          확인중
        </Progressed>
        <Completed requestState={personalBox?.requestState} data-testid="completed">
          완료
        </Completed>
      </StatusWrapper>
    </Wrapper>
