...
const ReviewInstructionDescription = styled.p`
  padding-top: 20px;
  padding-bottom: 31px;
`;

const ReviewInstructionList = styled.ul`
  padding-left: 8px;
...
export default function ReviewInstructionContent({ onClick }: Props) {
  return (
    <>
      <ReviewInstructionDescription>
        컬리는 믿을 수 있는 후기문화를 함께 만들어가고자 합니다. 식품 등의 표시광고에 대한 법률을 준수하고자 다음과 같은
        부당한 상품평에 대해서는 별도 고지 없이 임시 대처, 비공개 전환, 삭제, 적립금 회수 등의 필요한 조치가 취해 질 수
        있습니다.
      </ReviewInstructionDescription>
      <ReviewInstructionList>
        ...
        <li>
          ...
          모든 책임은 작성자에게 있습니다. 또한 비정상적인 방법을 통해 후기를 작성하고 적립금을 취득한 경우 작성자에
          법적 책임의 소지가 있음을 알려드립니다.
        </li>
      </ReviewInstructionList>
      <ButtonWrapper>
