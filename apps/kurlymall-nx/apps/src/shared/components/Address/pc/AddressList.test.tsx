...
describe('AddressList', () => {
  ...
  it('새 배송지 추가를 볼 수 있다.', () => {
    ...
    expect(container).toHaveTextContent('새 배송지 추가');
  });

  context('새 배송지 추가를 누르면', () => {
    it('handleCreate 가 실행된다.', () => {
      const { getByText } = renderAddressList();

      fireEvent.click(getByText('새 배송지 추가'));
