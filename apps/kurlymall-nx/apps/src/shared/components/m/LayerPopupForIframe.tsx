 ...
 * @param iframeUrl 레이어팝업에서 보여줄 iframe url
 *
 */
export default function LayerPopupForIframe({ isOpen, onClosePopup, headerTitle, iframeUrl }: LayerPopupProps) {
  ...
  return (
    <Wrapper isOpen={isOpen}>
      ...
      {isOpen && <Iframe key={`${iframeUrl}-key`} src={iframeUrl} />}
    </Wrapper>
  );
}
