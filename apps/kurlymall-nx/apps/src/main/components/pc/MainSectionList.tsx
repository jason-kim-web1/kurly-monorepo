...
import InstagramReviewContainer from './instagram-review/InstagramReviewContainer';
...
export default function MainSectionListPC({ section }: Props) {
  switch (section.type) {
    case 'MAIN_BANNERS':
    ...
    case 'MD_CHOICES':
      return <MdChoicesContainer section={section as MainMdChoicesSection} />;
    case 'CLOSING_SALE':
    ...
    case 'INSTAGRAM_REVIEW':
      return <InstagramReviewContainer section={section as MainInstagramReviewSection} />;
    ...
    case 'GROUP_COLLECTION_PRODUCT_NUMBER':
      return <GroupCollectionNumberSection section={section as MainGroupCollectionNumberSection} />;
    default:
      return null;
  }
}
