...
export type AlertProps = AlertTitleProps & AlertContentsProps & Omit<AlertButtonWrapperProps, 'onCloseReturnPromise'> & Omit<AlertBaseProps, 'onCloseReturnPromise'>;
...
export declare const BUTTON_LAYOUT: {
